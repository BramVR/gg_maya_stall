...
- Documented only: screenshot settle, kept-session TTL, and idle-timeout defaults from `docs/prd/0001-maya-stall-v1.md` and Crabbox default config. These are not broad-vendored until Maya Stall needs the behavior.
